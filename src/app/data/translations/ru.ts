...
export const ru: TranslatedStrings = {
  ...
  PSU: {
    ...
    description: `
      ...
      <p>
        За время учёбы было написано много полезных и бесполезных программ и игрушек. Большинство из них не опубликованы
        и хранятся на ${link('BitBucket', 'моём Битбакете')}. Единственное, что попало в публичный доступ &mdash;
        программа Gifed для статьи на ${link('Habr', 'Хабре')}. Раньше некоторые проекты были опубликованы на
        ${a('http://philip-s.narod.ru/', 'моём старом сайте')} в разделе &laquo;Проекты&raquo;, но сейчас уже ничего
      ...
      <p>
        ...
        тот момент являлся упрощённым форком сервиса Langaroo, над которым я ${link('Curriculum vitae', 'работал')}
        вместе с коллегой.
      </p>
