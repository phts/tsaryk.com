...
export const ru: TranslatedStrings = {
  ...
  Firefox: {
    ...
    description: `
      <p>
        ...
        настроить под себя, а также, самое главное, из-за навязывания его монополии.
      </p>
      <p>
        ${a(
  ...
  'Pilip Tsaryk': {
    name: 'Пiлiп Царык',
    description: p('Маё імя па-беларуску.'),
  },
  'Playing cards': {
...
большая и насчитывает на данный момент около 140 колод. Собираю именно те, \
которые понравились.',
      imgTitle: 'По одной карте из каждой колоды (кликабельно). Сентябрь 2026',
    },
  },
  Poland: {
    name: 'Польша',
