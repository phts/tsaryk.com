...
большая и насчитывает на данный момент около 100 колод. Собираю именно те, \
которые понравились.',
      imgTitle: 'По одной карте из каждой колоды (кликабельно). Февраль 2021',
    },
  },
  Poland: {
    name: 'Польша',
