  ...
  'Playing cards': {
    ...
    description: `
      ...
      <p>
        ...
        насчитывает на данный момент (январь 2019) около 70 колод. Собираю именно те, которые
        понравились.
      </p>
      <p>
        ${figure(picture('ziSatcX', 'Коллекция'), 'По одной карте из каждой колоды, январь 2019')}
      </p>
    `,
  },
  Poland: {
