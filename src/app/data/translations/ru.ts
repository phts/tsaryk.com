...
которые понравились.',
      imgTitle: 'По одной карте из каждой колоды (кликабельно). Апрель 2019',
    },
  },
  Poland: {
    name: 'Польша',
...
${link('Krako\u0301w', 'Краков')}.`),
  ...
  Traveling: {
    name: 'Путешествия',
    description: `
      <p>Я люблю путешествовать со своей ${link('Family', 'семьёй')}. На машине, на поезде, самолётом, как угодно.</p>
